...
import { createDefaultVariant as createDefaultButton } from '@/stores/button'
import { createDefaultVariant as createDefaultCard } from '@/stores/card'
import { createDefaultVariant as createDefaultAlert } from '@/stores/alert'
import { createDefaultVariant as createDefaultBadge } from '@/stores/badge'
import { createDefaultVariant as createDefaultChip } from '@/stores/chip'
import { createDefaultVariant as createDefaultDivider } from '@/stores/divider'
import { createDefaultVariant as createDefaultProgress } from '@/stores/progress'
import { createDefaultVariant as createDefaultSpinner } from '@/stores/spinner'
import { createDefaultVariant as createDefaultAvatar } from '@/stores/avatar'
import { createDefaultVariant as createDefaultTable } from '@/stores/table'
import { createDefaultVariant as createDefaultListGroup } from '@/stores/listgroup'
import { createDefaultVariant as createDefaultPagination } from '@/stores/pagination'
import { createDefaultVariant as createDefaultAccordion } from '@/stores/accordion'
import { createDefaultVariant as createDefaultTooltip } from '@/stores/tooltip'
import { createDefaultVariant as createDefaultPopover } from '@/stores/popover'
